...
public class ListPrice {
    ...
    public boolean equals(final Object o) {
        ...
        final ListPrice other = (ListPrice) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ListPrice;
    }
    ...
    public String toString() {
        return "ListPrice(amount=" + this.getAmount() + ", currencyCode=" + this.getCurrencyCode() + ", amountInMicros=" + this.getAmountInMicros() + ")";
    }
}